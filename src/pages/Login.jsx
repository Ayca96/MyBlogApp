...
const Login = () => {
  return (
    <section className="bg-white min-h-screen flex box-border justify-center items-center">
      <div className="bg-peachBeige rounded-2xl flex max-w-3xl p-5 items-center">
        ...
        <div className="md:block hidden w-1/2">
          <img className="rounded-2xl max-h-[1600px]" src="https://images.unsplash.com/photo-1561181286-d3fee7d55364?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="login form image" />
        </div>
      </div>
    </section>
  );
